...
object ConnHelper extends Serializable{
    // 懒变量定义，使用的时候才初始化
    lazy val jedis = new Jedis("192.168.73.104")
    lazy val mongoClient = MongoClient(MongoClientURI("mongodb://192.168.73.104:27017/recommender"))
}
...
object OnlineRecommender {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 创建kafka配置参数
        val kafkaParam = Map(
            "bootstrap.servers" -> "192.168.73.104:9092",
